...
== Install
  ...
  ./script/install plugin git://github.com/adzap/active_enum.git # for now, will gemify
...
Access the enum values and the enum class using the attribute method proxy
